...
var ClassnamesGenerator = /** @class */ (function () {
    ...
    function ClassnamesGenerator(parser) {
        ...
        this.layout = function () {
            var classnames = tslib_1.__assign(tslib_1.__assign({}, non_configurable_1.nonConfigurableClassNames.layout), { objectPosition: Object.keys(_this._theme.objectPosition).map(function (x) { return 'object-' + x; }), inset: Object.keys(_this._theme.inset).flatMap(function (insetValue) {
            ...
            if (_this.isJitModeEnabled()) {
                return tslib_1.__assign(tslib_1.__assign({}, classnames), { content: Object.keys(_this._theme.content).map(function (x) { return 'content-' + x; }) });
            }
            else {
                return classnames;
            }
        ...
        this.borders = function () {
            var classnames = tslib_1.__assign(tslib_1.__assign({}, non_configurable_1.nonConfigurableClassNames.borders), { 
            ...
            return _this.isJitModeEnabled()
                ? tslib_1.__assign(tslib_1.__assign({}, classnames), { caretColor: _this.generateClassesWithColors('caretColor') }) : classnames;
        };
        this.tables = function () {
            return non_configurable_1.nonConfigurableClassNames.tables;
        };
        this.effects = function () {
            return tslib_1.__assign(tslib_1.__assign({}, non_configurable_1.nonConfigurableClassNames.effects), { boxShadow: Object.keys(_this._theme.boxShadow).map(function (key) { return "shadow-" + key; }), opacity: _this.getGeneratedClassesWithOpacities().opacities });
        };
        ...
        this.interactivity = function () {
            return tslib_1.__assign(tslib_1.__assign({}, non_configurable_1.nonConfigurableClassNames.interactivity), { cursor: Object.keys(_this._theme.cursor).map(function (x) { return 'cursor-' + x; }), outline: Object.keys(_this._theme.outline).map(function (x) { return 'outline-' + x; }) });
        };
        this.SVG = function () {
        ...
        this.filters = function () {
            return tslib_1.__assign(tslib_1.__assign({}, non_configurable_1.nonConfigurableClassNames.filters), { blur: Object.keys(_this._theme.blur).map(function (x) { return 'blur-' + x; }), brightness: Object.keys(_this._theme.brightness).map(function (x) { return 'brightness-' + x; }), contrast: Object.keys(_this._theme.contrast).map(function (x) { return 'contrast-' + x; }), dropShadow: Object.keys(_this._theme.dropShadow).map(function (x) { return 'drop-shadow-' + x; }), grayscale: Object.keys(_this._theme.grayscale).map(function (x) { return 'grayscale-' + x; }), hueRotate: Object.keys(_this._theme.hueRotate).map(function (x) { return 'hue-rotate-' + x; }), invert: Object.keys(_this._theme.invert).map(function (x) { return 'invert-' + x; }), saturate: Object.keys(_this._theme.saturate).map(function (x) { return 'saturate-' + x; }), sepia: Object.keys(_this._theme.sepia).map(function (x) { return 'sepia-' + x; }), backdropBlur: Object.keys(_this._theme.backdropBlur).map(function (x) { return 'backdrop-blur-' + x; }), backdropBrightness: Object.keys(_this._theme.backdropBrightness).map(function (x) { return 'backdrop-brightness-' + x; }), backdropContrast: Object.keys(_this._theme.backdropContrast).map(function (x) { return 'backdrop-contrast-' + x; }), backdropGrayscale: Object.keys(_this._theme.backdropGrayscale).map(function (x) { return 'backdrop-grayscale-' + x; }), backdropHueRotate: Object.keys(_this._theme.backdropHueRotate).map(function (x) { return 'backdrop-hue-rotate-' + x; }), backdropInvert: Object.keys(_this._theme.backdropInvert).map(function (x) { return 'backdrop-invert-' + x; }), backdropOpacity: Object.keys(_this._theme.backdropOpacity).map(function (x) { return 'backdrop-opacity-' + x; }), backdropSaturate: Object.keys(_this._theme.backdropSaturate).map(function (x) { return 'backdrop-saturate-' + x; }), backdropSepia: Object.keys(_this._theme.backdropSepia).map(function (x) { return 'backdrop-sepia-' + x; }) });
        };
        this.flexBox = function () {
            return tslib_1.__assign(tslib_1.__assign({}, non_configurable_1.nonConfigurableClassNames.flexBox), { flexGrow: Object.keys(_this._theme.flexGrow).map(function (key) { return "flex-grow-" + key; }), flexShrink: Object.keys(_this._theme.flexShrink).map(function (key) { return "flex-shrink-" + key; }), order: Object.keys(_this._theme.order).map(function (key) { return "order-" + key; }) });
        };
        this.grid = function () {
        ...
        this.pseudoClasses = function () {
            ...
            var variantsConfig = Object.entries(lodash_1.default.merge(_this._configParser.getVariants(), {
                ...
                if (typeof colorValue === 'object' && colorValue !== null) {
                    ...
                    return Object.keys(colorValue).flatMap(function (shade) {
                        if (utilName === 'border' && _this.isJitModeEnabled()) {
                            return ['', 't', 'r', 'b', 'l'].map(function (side) { return utilName + "-" + side + "-" + colorName + "-" + shade; });
                        }
                        else {
